#ifndef __MT7621_NAND_DEF_H__
#define __MT7621_NAND_DEF_H__
...
#define NAND_MAX_OOBFREE_ENTRIES_LARGE	32
#define NAND_MAX_ECCPOS_ENTRIES_LARGE	448
...
struct nand_ecclayout {
	__u32 eccbytes;
	__u32 eccpos[NAND_MAX_ECCPOS_ENTRIES_LARGE];
	__u32 oobavail;
	struct nand_oobfree oobfree[NAND_MAX_OOBFREE_ENTRIES_LARGE];
};
