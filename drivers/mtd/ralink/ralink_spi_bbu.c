...
static struct chip_info chips_data[] = {
	...
	{ "FL016AIF",		0x01, 0x02140000, 64 * 1024,   32, 0, 0 },
	{ "FL064AIF",		0x01, 0x02160000, 64 * 1024,  128, 0, 0 },

	{ "S25FL032P",		0x01, 0x02154D00, 64 * 1024,   64, 0, 0 },
	{ "S25FL064P",		0x01, 0x02164D00, 64 * 1024,  128, 0, 0 },
	{ "S25FL128P",		0x01, 0x20180301, 64 * 1024,  256, 0, 0 },
	{ "S25FL129P",		0x01, 0x20184D01, 64 * 1024,  256, 0, 0 },
	{ "S25FL256S",		0x01, 0x02194D01, 64 * 1024,  512, 1, 0 },

	{ "S25FL116K",		0x01, 0x40150140, 64 * 1024,   32, 0, 0 },
	{ "S25FL132K",		0x01, 0x40160140, 64 * 1024,   64, 0, 0 },
	{ "S25FL164K",		0x01, 0x40170140, 64 * 1024,  128, 0, 0 },

	{ "EN25F16",		0x1c, 0x31151c31, 64 * 1024,   32, 0, 0 },
	{ "EN25F32",		0x1c, 0x31161c31, 64 * 1024,   64, 0, 0 },
	{ "EN25Q32B",		0x1c, 0x30161c30, 64 * 1024,   64, 0, 0 },
	{ "EN25F64",		0x1c, 0x20171c20, 64 * 1024,  128, 0, 0 }, /* EN25P64 */
	{ "EN25Q64",		0x1c, 0x30171c30, 64 * 1024,  128, 0, 0 },
	{ "EN25QH64A",		0x1c, 0x70171c70, 64 * 1024,  128, 0, 0 },
	{ "EN25Q128",		0x1c, 0x30181c30, 64 * 1024,  256, 0, 0 },
	{ "EN25QH128A",		0x1c, 0x70181c70, 64 * 1024,  256, 0, 0 },
	{ "EN25QH256A",		0x1c, 0x70191c70, 64 * 1024,  512, 1, 0 },
	{ "EN25QX256A",		0x1c, 0x71191c71, 64 * 1024,  512, 1, 1 },

	{ "AT26DF161",		0x1f, 0x46000000, 64 * 1024,   32, 0, 0 },
	{ "AT25DF321",		0x1f, 0x47000000, 64 * 1024,   64, 0, 0 },

	{ "N25Q032A",		0x20, 0xba161000, 64 * 1024,   64, 0, 0 },
	{ "N25Q064A",		0x20, 0xba171000, 64 * 1024,  128, 0, 0 },
	{ "N25Q128A",		0x20, 0xba181000, 64 * 1024,  256, 0, 0 },
	{ "N25Q256A",		0x20, 0xba191000, 64 * 1024,  512, 1, 0 },
	{ "XM25QH256B",		0x20, 0x60192060, 64 * 1024,  512, 1, 0 },
	{ "XM25QH256C",		0x20, 0x40192040, 64 * 1024,  512, 1, 1 },
	{ "MT25QL512AB",	0x20, 0xba201044, 64 * 1024, 1024, 1, 0 },

	{ "F25L32QA",		0x8c, 0x41168c41, 64 * 1024,   64, 0, 0 }, /* ESMT */
	{ "F25L64QA",		0x8c, 0x41170000, 64 * 1024,  128, 0, 0 }, /* ESMT */

	{ "MX25L1605D",		0xc2, 0x2015c220, 64 * 1024,   32, 0, 0 },
	{ "MX25L3205D",		0xc2, 0x2016c220, 64 * 1024,   64, 0, 0 },
	{ "MX25L6406E",		0xc2, 0x2017c220, 64 * 1024,  128, 0, 0 },
	{ "MX25L12835F",	0xc2, 0x2018c220, 64 * 1024,  256, 0, 0 },
	{ "MX25L25635F",	0xc2, 0x2019c220, 64 * 1024,  512, 1, 0 },
	{ "MX25L51245G",	0xc2, 0x201ac220, 64 * 1024, 1024, 1, 0 },

	{ "GD25Q32B",		0xc8, 0x40160000, 64 * 1024,   64, 0, 0 },
	{ "GD25Q64B",		0xc8, 0x40170000, 64 * 1024,  128, 0, 0 },
	{ "GD25Q64CSIG",	0xc8, 0x4017c840, 64 * 1024,  128, 0, 0 },
	{ "GD25Q128C",		0xc8, 0x40180000, 64 * 1024,  256, 0, 0 },
	{ "GD25Q128CSIG",	0xc8, 0x4018c840, 64 * 1024,  256, 0, 0 },
	{ "GD25Q256CSIG",	0xc8, 0x4019c840, 64 * 1024,  512, 1, 0 },

	{ "W25X32VS",		0xef, 0x30160000, 64 * 1024,   64, 0, 0 },
	{ "W25Q32BV",		0xef, 0x40160000, 64 * 1024,   64, 0, 0 },
	{ "W25Q64BV",		0xef, 0x40170000, 64 * 1024,  128, 0, 0 }, /* S25FL064K */
	{ "W25Q128FV",		0xef, 0x40180000, 64 * 1024,  256, 0, 0 },
	{ "W25Q256FV",		0xef, 0x40190000, 64 * 1024,  512, 1, 1 },

#if defined(CONFIG_RT2880_FLASH_64M)
	{ "Unknown",		0x00, 0xffffffff, 64 * 1024, 1024, 1, 0 },
#elif defined(CONFIG_RT2880_FLASH_32M) || defined(CONFIG_RT2880_FLASH_AUTO)
	{ "Unknown",		0x00, 0xffffffff, 64 * 1024,  512, 1, 0 },
#elif defined(CONFIG_RT2880_FLASH_16M)
	{ "Unknown",		0x00, 0xffffffff, 64 * 1024,  256, 0, 0 },
#elif defined(CONFIG_RT2880_FLASH_8M)
	{ "Unknown",		0x00, 0xffffffff, 64 * 1024,  128, 0, 0 },
#else
	{ "Unknown",		0x00, 0xffffffff, 64 * 1024,   64, 0, 0 },
#endif
};
...
static int raspi_4byte_mode(int enable)
{
	...
	if (chip->id == 0x1) {
		...
		/* clear extended address register */
		if (!enable && chip->addr4b_ext) {
			code = 0x0;
			raspi_write_enable();
