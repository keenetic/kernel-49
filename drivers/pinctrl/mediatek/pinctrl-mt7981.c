...
static const struct group_desc mt7981_groups[] = {
	...
	PINCTRL_PIN_GROUP("wm_uart_1", mt7981_wm_uart_1),
	/*  @GPIO(30,31): WM_UART(3) */
	PINCTRL_PIN_GROUP("wm_uart_2", mt7981_wm_uart_2),
	...
	/*  @GPIO(14,15,26,17,18,19,20,21,22,23,24,25,34,35): ANT_SEL(6) */
...
static const char *mt7981_wa_aice_groups[] = {
	"wa_aice1", "wa_aice2", "wm_aice1_1", "wa_aice3", "wm_aice1_2", };
static const char *mt7981_uart_groups[] = {
	"net_wo0_uart_txd_0", "net_wo0_uart_txd_1", "net_wo0_uart_txd_2",
	"uart0", "uart1_0", "uart1_1", "uart1_2", "uart2_0", "uart2_0_tx_rx",
	"uart2_1", "wm_uart_0", "wm_uart_1", "wm_uart_2", };
...
static const char *mt7981_jtag_groups[] = {
	"jtag", "wm_jtag_0", "wo0_jtag_0", "wo0_jtag_1", "wm_jtag_1", };
static const char *mt7981_led_groups[] = {
	"gbe_led0", "gbe_led1", "wf2g_led0", "wf2g_led1",
	"wf5g_led0", "wf5g_led1", };
...
static const char *mt7981_spi_groups[] = {
	"spi1_0", "spi0", "spi0_wp_hold", "spi1_1", "spi2", "spi2_wp_hold", };
static const char *mt7981_i2c_groups[] = {
	"i2c0_0", "i2c0_1", "u2_phy_i2c", "sgmii1_phy_i2c", "u3_phy_i2c",
