...
/* Note: MT7986B package has no pins 41..65 */
...
/* WF2G_LED */
static int mt7986_wf2g_led_pins[] = { 1, };
static int mt7986_wf2g_led_funcs[] = { 1, };

/* WF5G_LED */
static int mt7986_wf5g_led_pins[] = { 2, };
static int mt7986_wf5g_led_funcs[] = { 1, };
...
static int mt7986_wf_dbdc_funcs[] = { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, };
...
static const struct group_desc mt7986_groups[] = {
	...
	/*  @GPIO(1): WF2G_LED(1) */
	PINCTRL_PIN_GROUP("wf2g_led", mt7986_wf2g_led),
	/*  @GPIO(2): WF5G_LED(1) */
	PINCTRL_PIN_GROUP("wf5g_led", mt7986_wf5g_led),
	/*  @GPIO(3,4): I2C(1) */
...
static const char *mt7986_uart_groups[] = {
	...
	"uart1_3_rx_tx", "uart1_3_cts_rts", "uart1_rx_tx", "uart1_cts_rts",
	"uart2_0_rx_tx", "uart2_0_cts_rts", "uart2_1", "uart2", "uart0" };
...
static const struct function_desc mt7986_functions[] = {
	...
	{"pcm", mt7986_pcm_groups, ARRAY_SIZE(mt7986_pcm_groups)},
