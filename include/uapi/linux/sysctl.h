...
enum
{
	...
	NET_NF_CONNTRACK_NAT_MODE=34,
	NET_NF_CONNTRACK_NAT_CONE_IFINDEX=35,
#ifdef CONFIG_FAST_NAT_V2
	NET_NF_CONNTRACK_FASTPATH_PPTP=36,
	NET_NF_CONNTRACK_FASTPATH_L2TP=37,
	NET_NF_CONNTRACK_FASTPATH_ESP=38,
	NET_NF_CONNTRACK_FASTNAT_XFRM=39,
	NET_NF_CONNTRACK_FASTROUTE=40,
