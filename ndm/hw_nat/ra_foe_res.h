...
#define FOE_ENTRY_NUM_SRAM	0
 ...
 #undef FOE_ENTRY_OFS_DRAM
#define FOE_ENTRY_OFS_DRAM	 0
#define FOE_ENTRY_NUM_DRAM	(FOE_ENTRY_COUNT - FOE_ENTRY_NUM_SRAM)
#define FOE_ENTRY_NUM_RAW	 FOE_ENTRY_NUM_DRAM
#else
#define FOE_ENTRY_NUM_DRAM	 FOE_ENTRY_COUNT
#define FOE_ENTRY_NUM_RAW	(FOE_ENTRY_COUNT + FOE_ENTRY_OFS_DRAM)
#endif

#define FOE_ENTRY_TOTAL		(FOE_ENTRY_NUM_SRAM + FOE_ENTRY_NUM_DRAM)
#define FOE_TABLE_SIZE		(FOE_ENTRY_NUM_RAW * FOE_ENTRY_SIZE)
